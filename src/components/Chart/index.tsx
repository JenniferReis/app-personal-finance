...
export default function Chart() {
  ...
  return (
    <Paper height={320}>
      <ChartTitle>{`Finanças de ${currentMonthName}`}</ChartTitle>
      <ResponsiveContainer>
        <AreaChart width={500} height={320} 
        ...
        >
          ...
          <Tooltip />
          <Legend />
          <Area type="monotone" dataKey="Crédito" fill="#152f3e" stroke={HEXColor.Success} />
          <Area type="monotone" dataKey="Débito" fill="#3d202e" stroke={HEXColor.Error} />
        </AreaChart>
      </ResponsiveContainer>
    </Paper>
  );
